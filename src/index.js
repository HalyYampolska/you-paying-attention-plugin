...
import {InspectorControls, BlockControls, AlignmentToolbar, useBlocksProps} from "@wordpress/block-editor"
...
function EditComponent (props) {
    ...
    return (
        <div {...blockProps} >
            ...
            <TextControl label="Question:" value={props.attributes.question} onChange={updateQuestion} style={{fontSize: "20px"}} disableAlpha={true}/>
